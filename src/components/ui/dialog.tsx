...
const DialogPortal = memo(({ ...props }: any) => {
...
const DialogOverlay = memo(({ className, ...props }: any) => {
  return (
...
const DialogContent = memo(({ className, children, ...props }: any) => {
  return (
...
const DialogDescription = memo(({ className, ...props }: any) => {
  return (
