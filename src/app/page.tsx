  ...
  return (
    <ScrollArea className="lg:contents" useScrollAreaId>
      ...
      <div className="min-h-screen bg-white">
        <PageTitle title="Home" className="lg:hidden p-4 sm:p-8" />
          ...
          <div className="grid w-full max-w-6xl grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="flex flex-col justify-center space-y-4 sm:space-y-6">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="h-5 text-base text-gray-600 sm:text-lg lg:text-xl">
                  <Typewriter
                    texts={[
                      'Frontend Engineer',
                ...
                <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                  Hello guys! I'm a Senior Frontend Engineer at a Fortune 500 multinational corporation, where I bring
                  creativity and technical excellence to crafting exceptional web experiences.
                </p>

                <p className="text-sm leading-relaxed text-gray-700 sm:text-base">
                  With a deep passion for programming and innovative design, I find inspiration in music and
                  continuously enhance my English proficiency.
                </p>
