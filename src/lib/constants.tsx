...
export const PROFILES = {
  ...
  // bluesky: {
  //   title: 'Bluesky',
  //   url: 'https://staging.bsky.app/profile/blog.velen.fun'
  // },
  // readcv: {
  //   title: 'Read.cv',
  //   url: 'https://read.cv/Velen'
  // },
  // pinterest: {
  //   title: 'Pinterest',
...
// API Configuration - 始终使用生产环境
export const API_BASE_URL = 'https://velen-blog.pages.dev'
